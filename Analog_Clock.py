...
'''
FuncAnimation is the key to making our clock run, with which we can make 
an animation by repeatedly calling an update function.
'''
...
def update(now):
    ...
    '''
    we define the axes setting every time, that sticks from 1 to 12 clockwise and 
    1 at the top of a clock face. And theta offset is added so that the zero position 
    for the axis is now on the top of the clock face.
    '''
